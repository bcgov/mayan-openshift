...
docker-postgresql-start: ## Start a PostgreSQL Docker test container.
	...
	@while ! docker exec --interactive --tty $(CONTAINER_NAME_TEST_POSTGRESQL) psql --command "\l" --dbname=$(CONFIG_DEFAULT_DATABASE_NAME) --host=127.0.0.1 --username=$(CONFIG_DEFAULT_DATABASE_USER) >/dev/null 2>&1; do echo -n .;sleep 1; done
